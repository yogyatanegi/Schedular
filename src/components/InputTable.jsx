    ...
    <table className="w-full border-collapse border border-gray-300 text-center dark:border-gray-600">
        ...
        <tbody>
            {processes.map((process, index) => (
                <tr key={process.processId} className="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
                    <td className="border border-gray-300 dark:border-gray-600 px-4 py-2">P{index+1}</td>
