      ...
      <div className="min-h-screen flex flex-col">
        <header className="flex items-center justify-between p-4 bg-white dark:bg-gray-800 shadow">
          <nav className="space-x-4">
            ...
            <Link to="/simulate" className="text-gray-800 dark:text-gray-100 hover:underline">Simulate</Link>
            <Link to="/compare" className="text-gray-800 dark:text-gray-100 hover:underline">Compare</Link>
          </nav>
          <ThemeToggle />
        </header>
        ...
        <footer className="p-4 bg-white dark:bg-gray-800 text-center text-sm text-gray-600 dark:text-gray-400">
          © {new Date().getFullYear()} Process Scheduler
        </footer>
      </div>
    </Router>
  );
