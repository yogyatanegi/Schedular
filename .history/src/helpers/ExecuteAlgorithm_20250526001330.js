...
const executeSelectedAlgorithm = async (selectedAlgorithm, num_of_processes, processes, setProcesses, setUpdatedProcesses, setExecuted, setStatisticsData, setAnotherUpdatedProcesses,setCurrentProcess, getPaused) => {
    ...
    switch (selectedAlgorithm) {
        ...
        case STRF:
            ...
            break;
        case ROUND_ROBIN:
            await executeRoundRobin(processes, num_of_processes, setUpdatedProcesses, setAnotherUpdatedProcesses, setCurrentProcess, getr);
            setExecuted(true);
            data = computeStatistics(selectedAlgorithm, processes, setProcesses);
