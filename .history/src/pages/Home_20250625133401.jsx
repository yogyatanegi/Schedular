...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full bg-white dark:bg-gray-800 my-6 flex flex-row gap-10 text-gray-900 dark:text-gray-100">
        <div className="flex flex-row justify-evenly rounded-xl bg-slate-100 dark:bg-slate-800 w-[480px] h-[46%] p-5">
          <SelectAlgorithm
