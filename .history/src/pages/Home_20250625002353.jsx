...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full bg-white my-6 flex flex-row gap-10 dark:bg-gray-900 transition-colors duration-300">
        <div className="flex flex-row justify-evenly rounded-xl bg-slate-100 dark:bg-gray-800 w-[480px] h-[46%] p-5">
          <SelectAlgorithm
      ...
      <div className="flex flex-row justify-center rounded-xlw-[100%] h-[46%] p-5">
        <button
          ...
          className="simulate bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 transition-colors"
          >
          Compare Algorithms
        </button>
      </div>
