  ...
  return (
    <div className="flex justify-center space-x-4 mt-6">
      ...
      <button
        ...
        className="reset bg-orange-600 hover:bg-yellow-700 font-bold text-[1rem] text-center text-white px-[1.4rem] py-[0.4rem] mb-2 rounded-lg focus:outline-none"
      >
      ...
      <button
        className={`next bg-slate-500 hover:bg-slate-600  font-bold text-[0.9rem] text-center text-white p-[0.3rem] rounded-lg focus:outline-none`}
        type="submit"
        onClick={e => {
            e.preventDefault();
            navigate('/result');
