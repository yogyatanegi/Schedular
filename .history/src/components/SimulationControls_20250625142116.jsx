...
const SimulateControls = ({
  ...
  delayRef,
    ...
    const usesQuantum = (selectedAlgorithm === 6 || selectedAlgorithm === 7);
  //   useEffect(() => {
  //   if (setDelay) {
  //     const adjustedDelay = 1000 / simulationSpeed; // Higher speed = shorter delay
  //     setDelay(adjustedDelay);
  //   }
  // }, [simulationSpeed, setDelay]);
    useEffect(() => {
      delayRef.current = 1000 / simulationSpeed;
    }, [simulationSpeed]);
  return (
    <div className="bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 w-[400px] px-6 py-4 rounded-xl shadow-md">
      ...
      {usesQuantum && (
        <div className="mb-4">
            ...
            className="w-full p-2 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 borde border-gray-300 dark:border-gray-600 rounded"
            />
        </div>
      )}
