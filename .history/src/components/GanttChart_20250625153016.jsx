                    ...
                    isNonPreemptive && (
                        <div className='flex flex-row justify-center'>
                            {processes.map(process => (
                                ...
                                >
                                    <div className='text-[1rem] font-medium text-black dark:text-white'>{`${process.startTime}`}</div>
                                    <div className={`text-[1rem] font-medium text-black dark:text-white ${count===processes.length ? 'block' : 'hidden'}`}>{`${process.completionTime}`}</div>
                                </div>
                            ))} 
                        </div>
                    )
                    ...
                    !isNonPreemptive && (
                        <div className='flex flex-row justify-center'>
                            {processes.map(process => (
                                ...
                                >
                                    <div className='text-[0.8rem] font-medium text-black dark:text-white'>{`${process.startTime}`}</div>
                                    <div className={`text-[0.8rem] font-medium text-black dark:text-white ${count===processes.length? 'block' : 'hidden'}`}>{`${process.completionTime}`}</div>
