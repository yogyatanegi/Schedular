  ...
  return (
    <table className="w-full border-collapse border border-gray-300 text-center dark:border-gray-600">
        <thead>
            ...
            <th className="border border-gray-300 px-2 py-2">Process ID</th>
            <th className="border border-gray-300 px-2 py-2">Arrival Time</th>
            <th className="border border-gray-300 px-2 py-2">Burst Time</th>
            {usesPriority && (
